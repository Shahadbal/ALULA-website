            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr class="text-center">
                        ...
                        <td>{{$row->price}}</td>
                        <td><a href="{{route('delA',['x'=>$row])}}" style="text-decoration: none; color:black;" class="delete-link">  حذف  <i class="bi bi-trash text-danger p-2"></i></a></td> 
                        <td><a href="{{route('editA',['x'=>$row->id])}}" style="text-decoration: none; color:black;">تعديل<i class="bi bi-pencil-square text-success p-2"></i></a></td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
